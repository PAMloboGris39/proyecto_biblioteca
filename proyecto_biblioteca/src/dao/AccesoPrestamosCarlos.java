...
public class AccesoPrestamosCarlos {
	...
	switch (opcion) {
	case 1:
	AccesoPrestamosCarlos.insertarPrestamo();
	break;
	case 2:
	AccesoPrestamosCarlos.eliminarPrestamo();
	break;
	case 3:
	AccesoPrestamosCarlos.consultarPrestamos();
	break;
	case 4:
	AccesoPrestamosCarlos.consultarPrestamosNoDevueltos();
	break;
	case 5:
	AccesoPrestamosCarlos.consultarPrestamosPorFecha();
	break;
	case 6:
	AccesoPrestamosCarlos.actualizarPrestamo();
	break;
	case 0:
